...
import "./index.css";
import logo from "./image/logoDHCNDA.png"; 
...
const getValueData = async () => {
  try {
    const response = await axios.get(
      "https://datn-55d00-default-rtdb.asia-southeast1.firebasedatabase.app/Room1/read.json"
    );
...
//   try {
//     const response = await axios.get(
//       "https://datn-55d00-default-rtdb.asia-southeast1.firebasedatabase.app/Room2/read.json"
//     );
//     const result = response?.data;
...
useEffect(() => {
  const sendMail = async (temperature, humidity, smoke, temperature2, humidity2, smoke2) => {
    try {
      const emailData = {
        user_name: 'DATN',
        user_email: 'namnguyen150203@gmail.com',
        message: `Phòng 1: Nhiệt độ ${temperature}, Độ ẩm ${humidity}, Khói ${smoke}`,
      };

      // Gửi email bằng EmailJS
      const response = await emailjs.send(
        'nam12345678', // ID của service bạn đã tạo trên EmailJS
        'template_4nbwjhd', // ID của template bạn đã tạo trên EmailJS
        emailData,
        'DdHbwJ32F0VKj1g-5' // publicKey
      );
...
// hop 1
  ...
  const getStatusData = async () => {
    try {
      const response = await axios.get(
        "https://datn-55d00-default-rtdb.asia-southeast1.firebasedatabase.app/Room1/online.json"
      );
...
// hop 2
  ...
  //   try {
  //     const response = await axios.get(
  //       "https://datn-55d00-default-rtdb.asia-southeast1.firebasedatabase.app/Room2/online.json"
  //     );
